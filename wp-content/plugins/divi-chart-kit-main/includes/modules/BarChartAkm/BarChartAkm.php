...
class DICK_BarChartAKM extends ET_Builder_Module
{

    public $slug       = 'dick_bar_chart_akm';
    ...
    {
        $this->name = esc_html__('Bar Chart AKM', 'dick-divi-chart-kit-akm');
    }
    ...
    public function render($attrs, $render_slug, $content = null)
    {
        ...
        return sprintf(
            '<div class="dick-bar-chart-container" data-settings=\'%1$s\'>
